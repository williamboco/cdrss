                  ...
                  <form class="form-horizontal" id="patientEditForm" action="ajax/patientUpdate.php">
					...
					<input type="number" name="userID" value="<?php echo $_SESSION['userID'];?>" class="hidden">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                           <input type="text" class="form-control" name="contactnumber" pattern=".{0,11}" title="0 to 11 characters" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Mobile number/ Landline">
                        </div>
                     </div>
