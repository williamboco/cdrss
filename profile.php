                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
	                     ...
	                     <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                           <input type="number" min="0" class="form-control" name="idNumber" pattern=".{5,20}" title="5 to 20 characters" placeholder="Patient ID" required>
	                        </div>
	                     </div>
	                     <div class="form-group">
	                     ...
	                     <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                           <input type="number" min="0" class="form-control" name="contactnumber" pattern=".{0,11}" title="0 to 11 characters" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Mobile number/ Landline">
	                        </div>
	                     </div>
	                     <div class="form-group">
