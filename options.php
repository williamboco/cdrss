	...
	<div class="container">
		<div class="row" style="margin-top: 50px;">
			...
			<div class="col-sm-10">
					...
					<div class="btn-group btn-group-justified hidden" id="inventoryBtnGrp" data-toggle="buttons">
					...
					<div class="card">
						...
						<div class="inventory-responsive hidden">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-body">
				...
				<form id="add-inventory" class="addForm" action="ajax/table/medicineCreate.php">
					<h4>Add Medicine / Supply</h4><br>
					<div class="form-group">
						<select class="form-control" name="inventoryType" required>
	...
	<div class="modal fade" id="editModal" role="dialog">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-body">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<form id="edit-inventory" class="editForm" action="ajax/table/medicineUpdate.php">
