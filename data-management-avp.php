...
<body>
	...
	<div class="container">
		<div class="row" style="margin: 150px 100px 0px 100px;">
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-graduation-cap"></i> <big>Courses</big></a>
			</div>
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-laptop"></i>  <big>Tracks</big></a>
			</div>
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-building"></i>  <big>Departments</big></a>
			</div>
		</div>

		<div class="row" style="margin: 25px 100px 100px 100px;">
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-allergies"></i> <big>Allergies</big></a>
			</div>
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-notes-medical"></i> <big>Complaints</big></a>
			</div>
			<div class="col-sm-4">
				<a href="options-avp.php" class="btn btn-info btn-lg btn-block datamenu"><i class="fas fa-pills"></i> <big>Inventory</big></a>
			</div>
		</div>
