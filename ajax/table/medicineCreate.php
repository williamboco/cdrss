<?php
	...
	if($medicineType == '0') {
		...
		$query = "INSERT INTO `medicine` (`ID`, `genericName`, `brandName`, `type`, isSupply, `isDeleted`) VALUES (NULL, '$genericName', '$brandName', '$medicineForm', '$medicineType', '0')";
		...
		$query = "INSERT INTO `medicine` (`ID`, `genericName`, `brandName`, `type`, isSupply, `isDeleted`) VALUES (NULL, '$supplyName', '', '', '$medicineType', '0')";
